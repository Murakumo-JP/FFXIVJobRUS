(() =>{
   let db = {
      ...
      "Shake It Off": {
         ...
         "radius_img": 'R2',
         "radius": '30y',
         "content": 'Создает барьер вокруг персонажа и всех ближайших саппортийцев, который поглощает получаемый урон в количестве 15% от максимального HP цели.<br/>Снимает эффекты Thrill of Battle, Vengeance, и Raw Intuition, увеличивая прочность барьера на 2% за каждый снятый эффект.<br/>Продолжительность: 30 сек.<br/>Дополнительный эффект: постепенно восстанавливает HP<br/>Сила лечения: 100<br/>Продолжительность: 15 сек.<br/>Дополнительный эффект: восстанавливает HP цели<br/>Сила лечения: 300',
      },
      // PVE Skill 24
      "Inner Release": {
         "name": 'Inner Release',
