(() =>{
   let db = {
      ...
      "PVE Skill 29": {
         ...
         "radius_img": 'R1',
         "radius": '0y',
         "content": 'Позволяет выполнять Adloquium, Concitation, Indomitability или Excogitation без использование ресурсов, а также с гарантированным критическим эффектом восстановления HP.<br/>Продолжительность: 15 сек.',
      },
      // PVE Skill 30
      "PVE Skill 30": {
         "name": 'Fey Blessing',
